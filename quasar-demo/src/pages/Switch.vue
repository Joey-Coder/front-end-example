    ...
    return {
      ...
      attributesData: [
        ...
        },
        {
          ...
          value: 'String',
          desc: '激活状态颜色，默认为#dcdfe6'
        },
        {
          attribute: 'inactiveColor',
          value: 'String',
          desc: '未激化状态颜色，默认为#dcdfe6'
        }
      ],
      eventsColumns: [
        {
